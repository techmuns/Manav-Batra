...
import snapshotJson from "@/data/generated/screener-financials.json";
...
// The snapshot is bundled with the Worker at build time.  No runtime
// fetch to Screener happens here — the JSON is regenerated by the
// GitHub Actions ingestion job which commits it back to the repo,
// then re-deployed.
const SNAPSHOT = snapshotJson as unknown as GeneratedFinancialSnapshot;
